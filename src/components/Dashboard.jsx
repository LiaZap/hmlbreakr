...
const Dashboard = () => {
  ...
  return (
    <div className="relative w-full h-screen flex flex-col bg-[#1B1B1D] font-jakarta text-white select-none overflow-hidden">
      {/* Wrapper sticky pros banners — empilha PaymentFailed + Admin no topo
          sem que um sobreponha o outro (antes ambos usavam sticky top-0
          e o de z-index maior empurrava o outro pra fora). */}
      {(sub.ready && sub.showPaymentFailedBanner) || (isAdminViewing && !adminBannerMinimized) ? (
        <div className="sticky top-0 z-[60] shrink-0">
          ...
          {isAdminViewing && !adminBannerMinimized && (
            <div className="bg-gradient-to-r from-[#F5A623] to-[#E5961E] text-black shadow-md">
      ...
      {/* Modais flutuantes — não-sticky, podem ficar fora do wrapper acima */}
